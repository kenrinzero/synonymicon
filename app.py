...
LEIPZIG_WEB_UK_ZIPF = {}  # {word_lower: zipf}
...
def synonyms():
    ...
    VALID_CORPORA = {'wordfreq', 'subtlex', 'bnc', 'google_1grams', 'wikipedia', 'kaggle', 'opensubtitles', 'gutenberg', 'leipzig_news', 'leipzig_web_com', 'leipzig_web_uk'}
